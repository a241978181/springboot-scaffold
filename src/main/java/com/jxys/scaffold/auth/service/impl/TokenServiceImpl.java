package com.jxys.scaffold.auth.service.impl;
...
public class TokenServiceImpl implements TokenService {
     ...
     * 生成只有Id的Payload
     **/
    private Map<String, Object> buildPayloadOnlyId(String id) {
     ...
     **/
    @Override
    public String generate(Object subject, String id) {
     ...
     **/
    @Override
    public String generate(Object subject, String id, int hours) {
